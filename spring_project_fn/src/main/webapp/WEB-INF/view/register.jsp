...
<c:set var="contextPath" value="${pageContext.request.contextPath}"/>
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			...
			<form:form method="POST" action="/user/saveDetails" modelAttribute="userForm" class="form-signin">
           ...
           <button class="btn btn-lg btn-primary btn-block" type="submit">Submit</button>
				...
				<%-- <form action="login" method="POST">
					<input class="text" type="text" name="firstName"
						...
						<input
						class="text" type="text" name="lastName" placeholder="lastName"
						required=""> 
						<input
						class="text" type="text" name="userName" placeholder="userName"
						required=""> 
