					...
					<a class="dropdown-item d-flex align-items-center" href="#">
						<div class="dropdown-list-image mr-3">
							<img class="rounded-circle"
								src="/assests/img/undraw_profile_1.svg" alt="...">
						...
						<div class="dropdown-list-image mr-3">
							<img class="rounded-circle"
								src="/assests/img/undraw_profile_2.svg" alt="...">
						...
						<div class="dropdown-list-image mr-3">
							<img class="rounded-circle"
								src="/assests/img/undraw_profile_3.svg" alt="...">
			...
			<li class="nav-item dropdown no-arrow"><a
				...
				<div
					...
					<a class="dropdown-item" href="<c:url value="/logout" />"> <i
						class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i> Logout
					</a>
				</div></li>
